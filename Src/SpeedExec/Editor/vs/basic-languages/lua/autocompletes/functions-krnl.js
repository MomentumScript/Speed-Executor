	...
	exports.autocompletes = {
		"Function": {
			...
			"getidentity()": {
				...
				"documentation": {
					value: [
						"```lua", "getidentity()", "```",
						"",
						"Return the thread identity.",
					].join("\n")
				},
			},

			"setthreadidentity()": {
				"insertText": "setthreadidentity(${1:n})",
				"documentation": {
					value: [
						"```lua", "setthreadidentity(1:n)", "```",
						"",
						"Set the thread identity to the n.",
					].join("\n")
				},
			},
			...
			"identifyexecutor()": {
				...
				"documentation": {
					value: [
						"```lua", "identifyexecutor()", "```",
						"",
						"Return the executor name and version.",
					].join("\n")
				},
			},
